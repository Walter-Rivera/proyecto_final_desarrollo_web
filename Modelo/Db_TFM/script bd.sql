...
ALTER TABLE TIPO_MOVIMIENTO_USUARIO CONSTRAINT PK_TMU PRIMARY KEY(ID_TIPO_MOVIMIENTO);
...
ALTER TABLE CAMPO_AFECTADO_USUARIO CONSTRAINT PK_CAU PRIMARY KEY(ID_CAMPO);
